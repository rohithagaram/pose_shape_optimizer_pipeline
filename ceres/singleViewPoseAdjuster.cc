...
int main(int argc, char** argv){
	...
	if(argc < 2){
		inputFileName = "C:/Users/Manasa/Documents/pose_shape_optimizer_pipeline/ceres/ceres_input_singleViewPoseAdjuster.txt";
		outputFileName = "C:/Users/Manasa/Documents/pose_shape_optimizer_pipeline/ceres/ceres_output_singleViewPoseAdjuster.txt";
	}
	else if(argc < 3){
