function [scaled_wireframe, transformed_deformation_vectors] = scale_wireframe()
...
scaled_wireframe = [wireframe(1,:) * width_scale; wireframe(2,:) * length_scale; wireframe(3,:) * height_scale];
